      ...
      <div className="space-y-6">
              ...
              <div className="space-y-3">
                <label className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      handleUpdateSetting('notifications', 'desktop', e.target.checked)
                    }
                    className="w-4 h-4"
                  />
                ...
                <label className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      handleUpdateSetting('notifications', 'inApp', e.target.checked)
                    }
                    className="w-4 h-4"
                  />
                ...
                <label className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      handleUpdateSetting('notifications', 'soundEnabled', e.target.checked)
                    }
                    className="w-4 h-4"
                  />
              ...
              <div className="space-y-3">
                <label className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      handleUpdateSetting('notifications', 'requestCreated', e.target.checked)
                    }
                    className="w-4 h-4"
                  />
                ...
                <label className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      handleUpdateSetting('notifications', 'requestFilled', e.target.checked)
                    }
                    className="w-4 h-4"
                  />
                ...
                <label className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      handleUpdateSetting('notifications', 'autoMarkRead', e.target.checked)
                    }
                    className="w-4 h-4"
                  />
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleUpdateSetting('system', 'autoRefreshInterval', parseInt(e.target.value))
                    }
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleUpdateSetting('system', 'defaultTimeRange', e.target.value)
                    }
                    className="w-full p-2 border border-border rounded-md"
                  >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Configure default export behavior and formats</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleUpdateSetting('export', 'maxRows', parseInt(e.target.value))
                    }
                    min={100}
                    max={100000}
                  />
              ...
              <div className="space-y-3">
                <label className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      handleUpdateSetting('export', 'includeTimestamps', e.target.checked)
                    }
                    className="w-4 h-4"
                  />
                ...
                <label className="flex items-center gap-3">
                  <input
                    ...
                    onChange={(e) =>
                      handleUpdateSetting('export', 'includeSummary', e.target.checked)
                    }
                    className="w-4 h-4"
                  />
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleUpdateSetting('security', 'sessionTimeout', parseInt(e.target.value))
                      }
                      min={30}
                      max={1440}
                    />
                ...
                <div className="space-y-3">
                  <label className="flex items-center gap-3">
                    <input
                      ...
                      onChange={(e) =>
                        handleUpdateSetting('security', 'requirePasswordChange', e.target.checked)
                      }
                      className="w-4 h-4"
                    />
                  ...
                  <label className="flex items-center gap-3">
                    <input
                      ...
                      onChange={(e) =>
                        handleUpdateSetting('security', 'enableAuditLog', e.target.checked)
                      }
                      className="w-4 h-4"
                    />
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="text-sm text-muted-foreground">
                Database settings would be available here in a production environment. This might
                include backup scheduling, cleanup policies, and maintenance windows.
              </div>
