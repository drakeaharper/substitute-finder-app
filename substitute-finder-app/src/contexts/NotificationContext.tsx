...
interface NotificationContextType {
  ...
  sendNotification: (title: string, body: string, requestId?: string, userId?: string) => Promise<void>;
...
export function NotificationProvider({ children }: NotificationProviderProps) {
  ...
  const sendNotification = async (title: string, body: string, requestId?: string, userId?: string) => {
    try {
